...
// Numéros CC pour la réverbération
#define LAUNCHKEY_MINI_CC_REVERB_MIX 21   // Dry/Wet mix
#define LAUNCHKEY_MINI_CC_REVERB_SIZE 22  // Room size
#define LAUNCHKEY_MINI_CC_REVERB_DAMP 23  // Damping
#define LAUNCHKEY_MINI_CC_REVERB_WIDTH 24 // Largeur stéréo
