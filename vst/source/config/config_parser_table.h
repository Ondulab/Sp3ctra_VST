...
static const config_param_def_t CONFIG_PARAMS[] = {
    ...
    CONFIG_PARAM("strokeforge", "blob_base_threshold", PARAM_TYPE_FLOAT,
                 strokeforge_blob_base_threshold, 0.01f, 0.2f),
    CONFIG_PARAM("strokeforge", "blob_contrast_adaptive", PARAM_TYPE_BOOL,
                 strokeforge_blob_contrast_adaptive, 0, 1),
    CONFIG_PARAM("strokeforge", "blob_contrast_sensitivity", PARAM_TYPE_FLOAT,
                 strokeforge_blob_contrast_sensitivity, 0.0f, 1.0f),
    CONFIG_PARAM("strokeforge", "blob_min_width", PARAM_TYPE_INT,
                 strokeforge_blob_min_width, 1, 10),
    CONFIG_PARAM("strokeforge", "blob_merge_gap", PARAM_TYPE_INT,
                 strokeforge_blob_merge_gap, 0, 5),
    CONFIG_PARAM("strokeforge", "max_harmonics", PARAM_TYPE_INT,
                 strokeforge_max_harmonics, 1, 16),
    CONFIG_PARAM("strokeforge", "harmonic_amplitude_floor", PARAM_TYPE_FLOAT,
                 strokeforge_harmonic_amplitude_floor, 0.001f, 0.1f),
    CONFIG_PARAM("strokeforge", "volume_center_sigma", PARAM_TYPE_FLOAT,
                 strokeforge_volume_center_sigma, 0.1f, 2.0f),
    CONFIG_PARAM("strokeforge", "phase_coherence_enabled", PARAM_TYPE_BOOL,
                 strokeforge_phase_coherence_enabled, 0, 1),
    CONFIG_PARAM("strokeforge", "phase_smooth_alpha", PARAM_TYPE_FLOAT,
                 strokeforge_phase_smooth_alpha, 0.01f, 0.5f),
    CONFIG_PARAM("strokeforge", "morph_width_scale", PARAM_TYPE_FLOAT,
                 strokeforge_morph_width_scale, 2.0f, 500.0f),
    CONFIG_PARAM("strokeforge", "wavetable_min_width", PARAM_TYPE_INT,
                 strokeforge_wavetable_min_width, 1, 200),
};
